...
export default function MaintenancePage() {
  ...
  const validateStep1 = () => {
    ...
    if (!formData.customerPhone.trim()) {
      newErrors.customerPhone = 'الرجاء إدخال رقم الجوال';
    } else if (!/^05\d{8}$/.test(formData.customerPhone.replace(/\s/g, ''))) {
      newErrors.customerPhone = 'رقم الجوال غير صحيح (يجب أن يبدأ بـ 05 ويحتوي على 10 أرقام)';
    }

    if (!formData.motorcycleBrand) {
      newErrors.motorcycleBrand = 'الرجاء اختيار ماركة الدراجة';
    }
  ...
  return (
    <div className="min-h-screen bg-background py-6">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 animate-fade-in">
            ...
            <div className="space-y-4 animate-slide-up">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-background/50 text-white px-4 py-3 rounded-xl border transition-all focus:outline-none focus:ring-2 ${
                    errors.customerName
                ...
                />
                {errors.customerName && (
                  <p className="text-red-500 text-xs mt-1 animate-fade-in">{errors.customerName}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.customerPhone && (
                  <p className="text-red-500 text-xs mt-1 animate-fade-in">{errors.customerPhone}</p>
                )}
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    setFormData({ ...formData, motorcycleBrand: e.target.value });
                    if (errors.motorcycleBrand) setErrors({ ...errors, motorcycleBrand: '' });
                  }}
                  className={`w-full bg-background/50 text-white px-4 py-3 rounded-xl border transition-all focus:outline-none focus:ring-2 ${
                ...
                {errors.motorcycleBrand && (
                  <p className="text-red-500 text-xs mt-1 animate-fade-in">{errors.motorcycleBrand}</p>
                )}
              </div>
              ...
              <button
                ...
                className="w-full bg-primary text-white px-6 py-3 rounded-xl font-bold hover:bg-primary/90 transition-all ripple focus-ring active:scale-95"
              ...
              <div className="space-y-2">
                {maintenanceServices.map((service, index) => (
                  <button
                    ...
                    className={`w-full text-right px-4 py-3 rounded-xl transition-all focus-ring active:scale-[0.98] animate-fade-in ${
            ...
            <div className="space-y-4 animate-slide-up">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-background/50 text-white px-6 py-3 rounded-xl font-bold border border-white/10 hover:bg-background transition-all focus-ring active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className={`flex-1 bg-green-500 text-white px-6 py-3 rounded-xl font-bold hover:bg-green-600 transition-all flex items-center justify-center gap-2 focus-ring active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed ${isSubmitting ? 'loading' : ''}`}
