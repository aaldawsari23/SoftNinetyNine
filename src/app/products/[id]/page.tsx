...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        if (!foundProduct) {
          setError("المنتج غير موجود. يرجى العودة لاحقًا.");
          return;
        }
        ...
        setError("حدث خطأ أثناء تحميل المنتج. يرجى المحاولة مرة أخرى.");
      } finally {
        setIsLoading(false);
      }
    }
  ...
  const handleWhatsAppContact = () => {
    ...
    const message = `مرحباً، أرغب بالاستفسار عن المنتج: ${safeName}\nالسعر: ${safePrice} ${safeCurrency}`;
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="mt-4 text-text-muted">جاري تحميل المنتج...</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="card p-8 text-center">
          <p className="text-red-400 mb-4">{error || "المنتج غير موجود"}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="card p-4 bg-white/5">
            ...
            <img
              ...
              onError={(e) => {
                e.currentTarget.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="400"><rect fill="%23333" width="400" height="400"/><text x="50%" y="50%" text-anchor="middle" dy=".3em" fill="%23666" font-size="40">صورة المنتج</text></svg>';
              }}
            />
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            {product.sku && (
              <p className="text-sm text-text-muted mt-1">رقم المنتج: {product.sku}</p>
            )}
          </div>
          ...
          <div className="card p-6 bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
            <p className="text-sm text-text-secondary mb-2">السعر</p>
          ...
          {product.specifications && Object.keys(product.specifications).length > 0 && (
            <div className="card p-6">
              <h2 className="text-lg font-semibold text-white mb-3">المواصفات</h2>
