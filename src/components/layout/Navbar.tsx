        ...
        <div className="flex items-center justify-between h-16 md:h-18">
          ...
          <Link href="/" className="flex items-center gap-2.5 hover:opacity-90 transition-opacity">
            ...
            <div className="flex flex-col">
              <span className="text-primary font-bold text-base md:text-lg leading-tight">سوفت 99</span>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            {/* Store Icon - Cart Button - Premium Enhanced */}
            <button
              onClick={() => setIsCartOpen(true)}
              className="relative nav-icon-btn text-white bg-primary/15 hover:bg-primary/30 border border-primary/30 hover:border-primary/50 rounded-xl"
            ...
            >
              ...
              {mounted && getTotalItems() > 0 && (
                <span className="absolute -top-1.5 -right-1.5 bg-green-500 text-white text-xs rounded-full w-6 h-6 flex items-center justify-center font-bold shadow-lg shadow-green-500/30 animate-pulse">
                  {getTotalItems()}
                </span>
              )}
            </button>
